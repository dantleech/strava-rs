...
pub fn handle(app: &mut App, key: MappedKey) {
    ...
    match key.strava_event {
        ...
        StravaEvent::Next => table_state_next(&mut app.activity_list.table_state(), activities.len(), false),
        StravaEvent::Previous => table_state_prev(&mut app.activity_list.table_state(), activities.len(), false),
